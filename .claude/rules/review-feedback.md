...
- Read every review comment before making any change
- Apply all in-scope feedback within the current PR — do not defer in-scope items
- For each comment addressed, post a reply on that specific comment explaining what was done
